...
class TestManagerRetrieveView:
    ...
    def test_retrieve_by_non_manager(self, api_client, active_account):
        """Only admin or managers can access manager retrieve page"""
    ...
    def test_retrieve_non_existing_manager(self, api_client, superuser, unique_uuid):
        api_client.force_authenticate(superuser)
